<?php
	...
	$query = "INSERT INTO professor (name_first, name_last, adjunct) VALUES ('$name_last','$name_first',$_POST['adjunct']) ON CONFLICT (name_first, name_last) DO UPDATE set adjunct = $_POST['adjunct'];";

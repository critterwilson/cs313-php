...
<body>
	...
	<form id="teacherSetUp" action="insertProfessor.php" method="POST">
		...
		<input type="text" name="name_first" size="20" pattern="/^[a-zA-Z]+(([',.-][a-zA-Z ])?[a-zA-Z]*)*$/g" required>

		<h4>Which instrument do you prefer?</h4>
		<input type="text" name="name_last" size="20" pattern="/^[a-zA-Z]+(([',.-][a-zA-Z ])?[a-zA-Z]*)*$/g" required>
